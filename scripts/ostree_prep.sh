...
# Copied and adapted from https://salsa.debian.org/debian/ostree/-/blob/debian/master/debian/ostree-boot-examples/modified-deb-ostree-builder
...
ARCH="armv71"
SUITE="buster-console"
BUILDDIR=$tempdir
REPO=${REPO:-"$DIR/ignore/repo"}
